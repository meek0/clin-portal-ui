...
import { formatToK, getDateTime, getUrlLink, scientificToDecimal } from '../shared/Utils';
...
export const VariantsTable = {
    actions: {
      ...
      showColumn(columnID: string) {
        cy.showColumn(getColumnName(tableColumns, columnID), 0);
      },
      /**
