...
describe('Page des prescriptions et requêtes - Consultation du tableau des prescriptions', () => {
  ...
  it('Valider les fonctionnalités du tableau - Tris', () => {
    ...
    cy.sortTableAndWait('Prescription');
