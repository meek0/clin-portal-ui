...
describe('Page des variants d\'un patient (paired) - Consultation du tableau', () => {
  ...
  it('Vérifier les informations affichées', () => {
    ...
    cy.validateTableDataRowKeyClass('2f53f2ed574a720853172ff224c608efc5e3b623', 8, 'anticon');
    ...
    cy.validateTableDataRowKeyContent('2f53f2ed574a720853172ff224c608efc5e3b623', 17, '1.42e-6');
    cy.validateTableDataRowKeyContent('2f53f2ed574a720853172ff224c608efc5e3b623', 18, /^2$/);
