...
describe('Page des CNVs d\'un patient (somatic) - Consultation du tableau', () => {
  ...
  it('Valider les fonctionnalités du tableau - Tris [CLIN-2135]', () => {
    ...
    cy.sortTableAndIntercept('# Gènes', 3);
