...
describe('Modal des gènes chevauchant un CNV - Consultation du tableau', () => {
  ...
  it('Valider les fonctionnalités du tableau - Tri Gène', () => {
    ...
    cy.get('div[role="dialog"]').find('thead[class="ant-table-thead"]').contains('Gène').clickAndWait({force: true});
  ...
  it('Valider les fonctionnalités du tableau - Tri Longueur du gène', () => {
    ...
    cy.get('div[role="dialog"]').find('thead[class="ant-table-thead"]').contains('Longueur du gène').clickAndWait({force: true});
  ...
  it('Valider les fonctionnalités du tableau - Tri # Bases', () => {
    ...
    cy.get('div[role="dialog"]').find('thead[class="ant-table-thead"]').contains('# Bases').clickAndWait({force: true});
  ...
  it('Valider les fonctionnalités du tableau - Tri # Exons', () => {
    ...
    cy.get('div[role="dialog"]').find('thead[class="ant-table-thead"]').contains('# Exons').clickAndWait({force: true});
  ...
  it('Valider les fonctionnalités du tableau - Tri % CNV', () => {
    ...
    cy.get('div[role="dialog"]').find('thead[class="ant-table-thead"]').contains('% CNV').clickAndWait({force: true});
  ...
  it('Valider les fonctionnalités du tableau - Tri Type', () => {
    ...
    cy.get('div[role="dialog"]').find('thead[class="ant-table-thead"]').contains('Type').clickAndWait({force: true});
