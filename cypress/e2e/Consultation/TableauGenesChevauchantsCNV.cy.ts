...
//    cy.sortTableAndWait('Début');
    ...
    cy.get('div[role="dialog"] tr[data-row-key="OCLN"] td').eq(1).find('[class*="anticon"]').should('exist');
    cy.get('div[role="dialog"] tr[data-row-key="OCLN"] td').eq(2).contains('RGDI').should('exist');
    cy.get('div[role="dialog"] tr[data-row-key="OCLN"] td').eq(3).contains('65.6 kb').should('exist');
    cy.get('div[role="dialog"] tr[data-row-key="OCLN"] td').eq(4).contains('6.6 kb').should('exist');
    cy.get('div[role="dialog"] tr[data-row-key="OCLN"] td').eq(5).contains(/^2$/).should('exist');
    cy.get('div[role="dialog"] tr[data-row-key="OCLN"] td').eq(6).contains('10.1 %').should('exist');
    cy.get('div[role="dialog"] tr[data-row-key="OCLN"] td').eq(7).contains('24.2 %').should('exist');
    cy.get('div[role="dialog"] tr[data-row-key="OCLN"] td').eq(8).find('path[d*="M12.4"]').should('exist'); // Gène recoupe le CNV à une de ses extrémités
    cy.get('div[role="dialog"] tr[data-row-key="OCLN"] td').eq(8).find('path[d*="M15.6"]').should('exist');
  });
...
//    cy.sortTableAndWait('Début');
  ...
  it('Valider les liens disponibles Lien ClinGen', () => {
    ...
    cy.get('div[role="dialog"] tr[data-row-key="OCLN"]').find('td').eq(1).find('a[href]')
...
//    cy.sortTableAndWait('Début');
    ...
    cy.get('div[role="dialog"] tr[class*="ant-table-row"]').eq(0).find('td').eq(3).contains('35.0 kb').should('exist');
    cy.get('div[role="dialog"] thead[class="ant-table-thead"]').contains('Longueur du gène').clickAndWait({force: true});
    cy.get('div[role="dialog"] tr[class*="ant-table-row"]').eq(0).find('td').eq(3).contains('65.6 kb').should('exist');
  });
...
//    cy.sortTableAndWait('Début');
    ...
    cy.get('div[role="dialog"] tr[class*="ant-table-row"]').eq(0).find('td').eq(4).contains('6.6 kb').should('exist');
    cy.get('div[role="dialog"] thead[class="ant-table-thead"]').contains('# Bases').clickAndWait({force: true});
    cy.get('div[role="dialog"] tr[class*="ant-table-row"]').eq(0).find('td').eq(4).contains('18.6 kb').should('exist');
  });
...
//    cy.sortTableAndWait('Début');
    ...
    cy.get('div[role="dialog"] tr[class*="ant-table-row"]').eq(0).find('td').eq(5).contains(/^2$/).should('exist');
    cy.get('div[role="dialog"] thead[class="ant-table-thead"]').contains('# Exons').clickAndWait({force: true});
    cy.get('div[role="dialog"] tr[class*="ant-table-row"]').eq(0).find('td').eq(5).contains(/^10$/).should('exist');
  });
...
//    cy.sortTableAndWait('Début');
    ...
    cy.get('div[role="dialog"] thead[class="ant-table-thead"]').contains('% Gène').clickAndWait({force: true});
    cy.get('div[role="dialog"] tr[class*="ant-table-row"]').eq(0).find('td').eq(6).contains('10.1 %').should('exist');
    cy.get('div[role="dialog"] thead[class="ant-table-thead"]').contains('% Gène').clickAndWait({force: true});
    cy.get('div[role="dialog"] tr[class*="ant-table-row"]').eq(0).find('td').eq(6).contains('53.2 %').should('exist');
  });
...
//    cy.sortTableAndWait('Début');
    ...
    cy.get('div[role="dialog"] tr[class*="ant-table-row"]').eq(0).find('td').eq(7).contains('24.2 %').should('exist');
    cy.get('div[role="dialog"] thead[class="ant-table-thead"]').contains('% CNV').clickAndWait({force: true});
    cy.get('div[role="dialog"] tr[class*="ant-table-row"]').eq(0).find('td').eq(7).contains('68.2 %').should('exist');
  });
  ...
  it('Valider les fonctionnalités du tableau - Tri Type', () => {
    ...
    cy.get('div[role="dialog"] tr[class*="ant-table-row"]').eq(0).find('td').eq(8).find('path[d*="M12.4"]').should('exist'); // Gène recoupe le CNV à une de ses extrémités
    cy.get('div[role="dialog"] tr[class*="ant-table-row"]').eq(0).find('td').eq(8).find('path[d*="M15.6"]').should('exist');
    cy.get('div[role="dialog"] thead[class="ant-table-thead"]').contains('Type').clickAndWait({force: true});
    cy.get('div[role="dialog"] tr[class*="ant-table-row"]').eq(0).find('td').eq(8).find('path[d*="M10.8"]').should('exist'); // Gène entièrement contenu dans le CNV
    cy.get('div[role="dialog"] tr[class*="ant-table-row"]').eq(0).find('td').eq(8).find('path[d*="M13.2"]').should('exist');
  });
