...
const strVarUrlCHUSJCHUSJ   = '/snv/exploration/patient/'+epCHUSJ_ldmCHUSJ.patientId+'/'+epCHUSJ_ldmCHUSJ.prescriptionId;
const strVarUrlCUSMCHUSJ    = '/snv/exploration/patient/'+epCUSM_ldmCHUSJ.patientId+'/'+epCUSM_ldmCHUSJ.prescriptionId;
const strVarUrlCUSMCUSM     = '/snv/exploration/patient/'+epCUSM_ldmCUSM.patientId+'/'+epCUSM_ldmCUSM.prescriptionId;
const strVarUrlCHUSCHUS     = '/snv/exploration/patient/'+epCHUS_ldmCHUS.patientId+'/'+epCHUS_ldmCHUS.prescriptionId;
