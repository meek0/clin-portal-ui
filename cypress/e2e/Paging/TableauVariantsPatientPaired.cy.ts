...
describe('Tableau des variants d\'un patient (paired) - Valider avec des mocks', () => {
  ...
  it('Pagination', () => {
    ...
    cy.fixture('ResponseBody/VariantsPatientPairedPagingNext1.json').then((mockResponseBody) => {
      cy.intercept('POST', '**/graphql', (req) => {
        if (req.body.query.includes('VariantInformation')) {
    ...
    cy.fixture('ResponseBody/VariantsPatientPairedPagingNext2.json').then((mockResponseBody) => {
      cy.intercept('POST', '**/graphql', (req) => {
        if (req.body.query.includes('VariantInformation')) {
    ...
    cy.fixture('ResponseBody/VariantsPatientPairedPagingPrev.json').then((mockResponseBody) => {
      cy.intercept('POST', '**/graphql', (req) => {
        if (req.body.query.includes('VariantInformation')) {
