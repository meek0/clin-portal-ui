...
import ConsequencesCell from 'views/Cnv/components/ConsequencesCell';
...
export const getVariantColumns = (
  ...
  const columns: ProColumnType<ITableVariantEntity>[] = [
    ...
    {
      key: 'rsnumber',
      title: intl.get('screen.patientcnv.results.table.dbsnp'),
      dataIndex: 'rsnumber',
    ...
    {
      key: 'consequences',
      title: intl.get('screen.patientcnv.results.table.consequence'),
    ...
    {
      key: 'clinvar',
      title: intl.get('screen.patientcnv.results.table.clinvar'),
      dataIndex: 'clinvar',
      className: cx(style.variantTableCell, style.variantTableCellElipsis),
    ...
    {
      key: 'acmgVerdict',
      displayTitle: intl.get('screen.patientcnv.results.table.acmgVerdict'),
      title: (
        <Tooltip title={intl.get('screen.patientcnv.results.table.acmgVerdict.tooltip')}>
          {intl.get('screen.patientcnv.results.table.acmgVerdict')}
        </Tooltip>
      ),
      dataIndex: 'locus',
      className: cx(style.variantTableCell, style.variantTableCellElipsis),
    ...
    {
      key: 'rqdm',
      displayTitle: intl.get('screen.patientcnv.results.table.rqdm'),
      title: (
        <Tooltip title={intl.get('screen.patientcnv.results.table.rqdm.title.tooltip')}>
          {intl.get('screen.patientcnv.results.table.rqdm')}
        </Tooltip>
      ),
  ...
  if (patientId) {
    columns.push(
      {
        key: 'donors_zygosity',
        title: intl.get('screen.patientcnv.results.table.zygosity'),
        dataIndex: 'donors',
      ...
      },
      {
        ...
        key: 'actions',
        title: intl.get('screen.patientcnv.results.table.actions'),
      ...
      {
        key: 'ch',
        displayTitle: intl.get('screen.patientcnv.results.table.ch'),
        title: (
          <Tooltip title={intl.get('ch.tooltip')}>
            {intl.get('screen.patientcnv.results.table.ch')}
          </Tooltip>
        ),
        defaultHidden: true,
        render: (record: VariantEntity) => (
      ...
      {
        key: 'pch',
        displayTitle: intl.get('screen.patientcnv.results.table.pch'),
        title: (
          <Tooltip title={intl.get('pch.tooltip')}>
            {intl.get('screen.patientcnv.results.table.pch')}
          </Tooltip>
        ),
        defaultHidden: true,
        render: (record: VariantEntity) => (
      ...
      {
        key: 'alt',
        displayTitle: intl.get('screen.patientcnv.results.table.altprof'),
        title: (
          <Tooltip title={intl.get('filters.group.donors.ad_alt')}>
            {intl.get('screen.patientcnv.results.table.altprof')}
          </Tooltip>
        ),
        defaultHidden: true,
        render: (record: VariantEntity) =>
      ...
      {
        key: 'alttotal',
        displayTitle: intl.get('screen.patientcnv.results.table.alttotal'),
        title: (
          <Tooltip title={intl.get('total.depth')}>
            {intl.get('screen.patientcnv.results.table.alttotal')}
          </Tooltip>
        ),
        defaultHidden: true,
        render: (record: VariantEntity) =>
      ...
      {
        key: 'altratio',
        displayTitle: intl.get('screen.patientcnv.results.table.altratio'),
        title: (
          <Tooltip title={intl.get('allelic.ratio')}>
            {intl.get('screen.patientcnv.results.table.altratio')}
          </Tooltip>
        ),
        defaultHidden: true,
        render: (record: VariantEntity) =>
      ...
      {
        key: 'gq',
        displayTitle: intl.get('screen.patientcnv.results.table.gq'),
        title: (
          <Tooltip title={intl.get('gq.tooltip')}>
            {intl.get('screen.patientcnv.results.table.gq')}
          </Tooltip>
        ),
        defaultHidden: true,
        render: (record: VariantEntity) =>
      ...
      {
        key: 'filter',
        displayTitle: intl.get('screen.patientcnv.results.table.filter'),
        title: (
          <Tooltip title={intl.get('screen.variantDetails.patientsTab.filter.tooltip')}>
            {intl.get('screen.patientcnv.results.table.filter')}
          </Tooltip>
        ),
        defaultHidden: true,
        render: (record: VariantEntity) =>
