  ...
  [FilterTypes.Variant_germline]: {
    customSearches: () => [
      <VariantGeneSearch
        ...
        queryBuilderId={isCustomPills ? QUERY_EDITION_QB_ID : VARIANT_RQDM_QB_ID}
      />,
    ],
    groups: [
      {
  ...
  menuItems.push(
    {
      ...
      panelContent: filtersContainer(
        variantMappingResults,
        INDEXES.VARIANT,
        isCustomPillMenuEdition ? QUERY_EDITION_QB_ID : VARIANT_RQDM_QB_ID,
        getFilterGroups(isCustomPillMenuEdition)[FilterTypes.Patient],
        filterMapper,
      ),
    },
    {
      ...
      panelContent: filtersContainer(
        ...
        INDEXES.VARIANT,
        isCustomPillMenuEdition ? QUERY_EDITION_QB_ID : VARIANT_RQDM_QB_ID,
        getFilterGroups(isCustomPillMenuEdition)[FilterTypes.Variant_germline],
        filterMapper,
      ),
    },
    {
      ...
      panelContent: filtersContainer(
        ...
        INDEXES.VARIANT,
        isCustomPillMenuEdition ? QUERY_EDITION_QB_ID : VARIANT_RQDM_QB_ID,
        getFilterGroups(isCustomPillMenuEdition)[FilterTypes.Gene_germline],
        filterMapper,
      ),
    },
    {
      ...
      panelContent: filtersContainer(
        ...
        INDEXES.VARIANT,
        isCustomPillMenuEdition ? QUERY_EDITION_QB_ID : VARIANT_RQDM_QB_ID,
        getFilterGroups(isCustomPillMenuEdition)[FilterTypes.Frequency_germline],
        filterMapper,
      ),
    },
    {
      ...
      panelContent: filtersContainer(
        ...
        INDEXES.VARIANT,
        isCustomPillMenuEdition ? QUERY_EDITION_QB_ID : VARIANT_RQDM_QB_ID,
        getFilterGroups(isCustomPillMenuEdition)[FilterTypes.Pathogenicity_germline],
        filterMapper,
      ),
    },
  );
