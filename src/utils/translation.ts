    ...
    query: {
      ...
      facetValueMapping: {
        ...
        'genes.panels': {
          ...
          DYSM: intl.get('filters.options.panels.DYSM'),
          RHAB: intl.get('filters.options.panels.RHAB'),
          MYAC: intl.get('filters.options.panels.MYAC'),
          MYOC: intl.get('filters.options.panels.MYOC'),
          HYPM: intl.get('filters.options.panels.HYPM'),
          MITN: intl.get('filters.options.panels.MITN'),
          RGDI: intl.get('filters.options.panels.RGDI'),
          'RGDI+': intl.get('filters.options.panels.RGDI+'),
          POLYM: intl.get('filters.options.panels.POLYM'),
          TUPED: intl.get('filters.options.panels.TUPED'),
          TUHEM: intl.get('filters.options.panels.TUHEM'),
          SSOLID: intl.get('filters.options.panels.SSOLID'),
          SHEMA: intl.get('filters.options.panels.SHEMA'),
          SCID: intl.get('filters.options.panels.SCID'),
        },
        panels: {
          MMG: intl.get('filters.options.panels.MMG'),
          DYSM: intl.get('filters.options.panels.DYSM'),
