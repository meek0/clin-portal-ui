...
export const getQueryBuilderDictionary = (
  ...
  const analysisMap = {
    ...
    DPSO: getAnalysisNameByCode('DPSO'),
    DYSM: getAnalysisNameByCode('DYSM'),
    DYSTM: getAnalysisNameByCode('DYSTM'),
    EIDC: getAnalysisNameByCode('EIDC'),
    EIDI: getAnalysisNameByCode('EIDI'),
    EIII: getAnalysisNameByCode('EIII'),
    EPIL: getAnalysisNameByCode('EPIL'),
    EXTUM: getAnalysisNameByCode('EXTUM'),
    FEAN: getAnalysisNameByCode('FEAN'),
    GENOR: getAnalysisNameByCode('GENOR'),
    HDIP: getAnalysisNameByCode('HDIP'),
    HLH: getAnalysisNameByCode('HLH'),
    HLEB: getAnalysisNameByCode('HLEB'),
    HYPM: getAnalysisNameByCode('HYPM'),
    MAI: getAnalysisNameByCode('MAI'),
    MITN: getAnalysisNameByCode('MITN'),
    MMG: getAnalysisNameByCode('MMG'),
    MSMD: getAnalysisNameByCode('MSMD'),
    MYAC: getAnalysisNameByCode('MYAC'),
    MYOC: getAnalysisNameByCode('MYOC'),
    NPC: getAnalysisNameByCode('NPC'),
    POLYM: getAnalysisNameByCode('POLYM'),
    RETINO: getAnalysisNameByCode('RETINO'),
    RGDI: getAnalysisNameByCode('RGDI'),
    RHAB: getAnalysisNameByCode('RHAB'),
    SCID: getAnalysisNameByCode('SCID'),
    SHEMA: getAnalysisNameByCode('SHEMA'),
    SHIGE: getAnalysisNameByCode('SHIGE'),
    SLA: getAnalysisNameByCode('SLA'),
    STMO: getAnalysisNameByCode('STMO'),
    SURD: getAnalysisNameByCode('SURD'),
    TRATU: getAnalysisNameByCode('TRATU'),
    TUHEM: getAnalysisNameByCode('TUHEM'),
    TUPED: getAnalysisNameByCode('TUPED'),
    VEOIB: getAnalysisNameByCode('VEOIB'),
  };
