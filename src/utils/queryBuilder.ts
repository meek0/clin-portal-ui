...
export const SNV_EXPLORATION_PATIENT_TO_FILTER_TAG = 'snv_exploration_to_patient';
export const SNV_EXPLORATION_PATIENT_TN_FILTER_TAG = 'snv_exploration_tn_patient';
...
export const FILTER_TAG_QB_ID_MAPPING: Record<string, string> = {
  ...
  [SNV_EXPLORATION_PATIENT_TO_FILTER_TAG]: SNV_VARIANT_PATIENT_TO_QB_ID,
  [SNV_EXPLORATION_PATIENT_TN_FILTER_TAG]: SNV_VARIANT_PATIENT_TN_QB_ID,
